  ...
  return (
    <div className="relative min-h-screen bg-base-200 py-30 px-6 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto max-w-4xl">
        ...
        >
          Questions, feedback, or collaboration inquiries? Fill out the form below or reach out via our contact info. We are here to help you grow with Task Mint.
        </motion.p>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          ...
          >
            ...
            <p className="text-gray-600 text-center">support@taskmint.com</p>
          </motion.div>
