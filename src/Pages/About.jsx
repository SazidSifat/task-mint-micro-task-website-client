  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-purple-50 via-pink-50 to-purple-100 overflow-hidden py-30">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          >
            ...
            <p className="text-gray-700 leading-relaxed">
              Our mission is to <span className="font-semibold">empower individuals</span> by offering micro-tasks that generate income while improving technical knowledge and real-world digital skills. Task Mint makes earning accessible to everyone.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-700 leading-relaxed">
              We envision a <span className="font-semibold">global community</span> where anyone, regardless of background, can earn online, learn new skills, and improve career prospects. Task Mint bridges the gap between <span className="font-semibold">earning and learning</span>.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-700 leading-relaxed mb-5">
              Task Mint is open for developers globally to collaborate, contribute features, fix bugs, and enhance the platform. Grow as a developer while impacting thousands of users.
            </p>
            <a
        ...
        >
          <p>🌱 Task Mint is not just a platform – it’s a <span className="font-semibold text-secondary">community</span> where every small contribution matters.</p>
          ...
          <p>🎓 Task Mint also provides <span className="font-semibold text-secondary">learning resources</span> and tutorials to help users improve their digital skills and knowledge.</p>
